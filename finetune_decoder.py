...
history = decoder.fit(train_dataset, validation_data=val_dataset, epochs=30)
# #decoder.save('/content/drive/MyDrive/models/decoder_4x4/decoder_4x4_new.h5')
# decoder.save('/content/drive/MyDrive/models/decoder_4x4/decoder_4x4_new.h5')
decoder.save('/content/drive/MyDrive/stable_diffusion_4x4/decoder_model_scaled_linear/decoder.h5')