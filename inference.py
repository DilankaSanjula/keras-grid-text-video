...
grid_model.diffusion_model.load_weights("/content/drive/MyDrive/stable_diffusion_4x4/diffusion_model_stage_7/best_mixed_2.h5")
...
prompts = ["grid image of homer drooling"]
