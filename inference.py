...
grid_model.decoder.load_weights("/content/drive/MyDrive/stable_diffusion_4x4/decoder_model_scaled_linear/decoder2.h5")
...
for i, image_array in enumerate(generated_images):
    ...
    file_path = f"/content/drive/MyDrive/stable_diffusion_4x4/scaled_linear_7.5_no_decoder2{i}.png"
    img.save(file_path)
